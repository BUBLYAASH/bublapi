...
public class UserController {
   ...
   @PatchMapping("/{userId}")
   public UserResponseDto updateUser(@PathVariable UUID clinicId, @PathVariable UUID userId, @Valid @RequestBody UpdateUserRequestDto request) {
   ...
   public UserRoleResponseDto assignRole(@PathVariable UUID clinicId, @PathVariable UUID userId, @PathVariable UUID roleId) {
   ...
   public UserRoleResponseDto removeRole(@PathVariable UUID clinicId, @PathVariable UUID userId, @PathVariable UUID roleId) {
   ...
   //TODO: Current PATCH -> /api/me/deactivation after integrating JWT and Spring Security
   ...
   //TODO: Current PATCH -> /api/me/activation after integrating JWT and Spring Security
